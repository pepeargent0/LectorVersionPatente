...
class PlateDetector:
    ...
    def procesar_salida_yolo(self, output):
        """
        Modificado de https://github.com/hunglc007/tensorflow-yolov4-tflite/blob
        /9f16748aa3f45ff240608da4bd9b1216a29127f5/detectvideo.py#L91 Aplica a la salida de yolo Non Max Suppression (
        NMS) eliminando detecciones duplicadas del mismo objeto
